import { type ColumnDef, type ColumnFilter, flexRender, getCoreRowModel, getFilteredRowModel, getPaginationRowModel, getSortedRowModel, type Table, useReactTable } from "@tanstack/react-table";
...
import { type Client, client0, useAddClientMutation, useDeleteClientMutation, useGetClientsQuery, useUpdateClientMutation } from "../../../features/client/clientApiSlice";
import { type Operation, WAIT } from "../../../features/Types";
