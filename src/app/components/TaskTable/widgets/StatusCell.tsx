...
import { type Client, type Status, STATUS_COLOR } from "../../../../features/client/clientApiSlice";
import { findColor } from "../../../../features/Types";
import { type CellProps } from "./EditableCell";

const StatusCell = ({ getValue, row, table }: CellProps) => {
